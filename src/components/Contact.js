  ...
  return (
    <div className="container my-2">
      ...
      <div className="container my-3">
        <div className="d-flex justify-content-start text-light p-1">
          <FontAwesomeIcon icon={faEnvelope} size="2x" className='px-2' />
          <p className="fs-5">moningiramachandrarao@gmail.com</p>
        </div>
        <div className="d-flex justify-content-start text-light p-1">
          <FontAwesomeIcon icon={faPhone} size="2x" className='px-2' />
          <p className="fs-5">9515278387</p>
        </div>
        <div className="d-flex justify-content-start text-light p-1">
          <FontAwesomeIcon icon={faHome} size="2x" className='px-2' />
          <p className="fs-5">Hiramandalam, Srikakulam District</p>
        </div>
      </div>
    </div>
  );
